...
def get_audio_features(path, sample_rate, audio_duration):
	"""
	Load and preprocess audio file to raw waveform.
...
class RawAudioProcessor:
	...
	def get_features_pipeline(self, path):
		...
		Returns:
			Tensor: Processed audio waveform.
		"""
		return get_audio_features(path, self.sample_rate, self.audio_duration)
