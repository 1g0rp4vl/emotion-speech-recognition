...
def main(cfg: DictConfig):
	download_data(
		cfg.prepare_data.data_root, cfg.prepare_data.zip_file, cfg.prepare_data.dataset_url
	)
	extract_data(cfg.prepare_data.zip_file, cfg.prepare_data.extract_dir)
	organize_data(
		cfg.prepare_data.data_root, cfg.prepare_data.extract_dir, cfg.prepare_data.emotions_mapping
	)
	print(
		f'Done! Dataset is ready in {cfg.prepare_data.data_root}/train \
			and {cfg.prepare_data.data_root}/val'
	)
